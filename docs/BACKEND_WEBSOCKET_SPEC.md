...
Headers:
  ...
  X-Edge-Agent-Id: edge_13107404018
```
...
**Log on connection:**
```
[INFO] Edge agent edge_13107404018 connected from IP 1.2.3.4
```

**Log on command sent:**
```
[INFO] Sent command cmd_1234567890 to edge_13107404018 (type: send_message)
```

**Log on disconnection:**
```
[WARN] Edge agent edge_13107404018 disconnected (duration: 3600s)
```
...
wsServer.sendCommand('edge_13107404018', {
  command_id: 'cmd_123',
  command_type: 'send_message',
  parameters: {
    thread_id: '+13105551234',
